...
import ru.otus.courses.java.advanced.shooter.server.gateway.player.mapper.market.MoneyBundleMapper;
...
public class MoneyBundleController {
    ...
    public Mono<MoneyBundleDto> fetchOne(@AuthenticationPrincipal Jwt jwt, @PathVariable int id) {
        ...
        Mono<CurrencyMappingContext> contextMono = currencyMappingContextFactory.createForMoneyBundle(moneyBundleInfoMono);
    ...
    public Mono<MoneyBundlePageResponseDto> fetchPage(
        ...
        Mono<CurrencyMappingContext> contextMono = currencyMappingContextFactory.createForMoneyBundles(moneyBundlesMono);
