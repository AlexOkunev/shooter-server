...
public class KafkaListenerConfig {
    ...
    public static final String SINGLE_THREAD_CURRENCY_KAFKA_LISTENER_CONTAINER_FACTORY = "singleThreadCurrencyKafkaListenerContainerFactory";
    ...
    public static final String MULTI_THREAD_PRODUCT_ISSUANCE_PERFORMED_KAFKA_LISTENER_CONTAINER_FACTORY = "multiThreadProductIssuancePerformedKafkaListenerContainerFactory";
    ...
    @Bean(name = SINGLE_THREAD_CURRENCY_KAFKA_LISTENER_CONTAINER_FACTORY)
    public ConcurrentKafkaListenerContainerFactory<Object, Object> singleThreadCurrencyKafkaListenerContainerFactory(
            ConsumerFactory<Object, Object> consumerFactory,
            @Qualifier(KafkaErrorHandlerConfig.KAFKA_ERROR_HANDLER) DefaultErrorHandler errorHandler
    ) {
        ConcurrentKafkaListenerContainerFactory<Object, Object> factory = new ConcurrentKafkaListenerContainerFactory<>();
    ...
    @Bean(name = MULTI_THREAD_PRODUCT_ISSUANCE_PERFORMED_KAFKA_LISTENER_CONTAINER_FACTORY)
    public ConcurrentKafkaListenerContainerFactory<Object, Object> multiThreadProductIssuancePerformedKafkaListenerContainerFactory(
            ConsumerFactory<Object, Object> consumerFactory,
            @Qualifier(KafkaErrorHandlerConfig.KAFKA_ERROR_HANDLER) DefaultErrorHandler errorHandler
    ) {
        ConcurrentKafkaListenerContainerFactory<Object, Object> factory = new ConcurrentKafkaListenerContainerFactory<>();
