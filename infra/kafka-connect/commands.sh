...
curl -X POST --data-binary "@./connectors/source/players_source.json" -H "Content-Type: application/json" http://localhost:8083/connectors | jq

curl -X POST --data-binary "@./connectors/source/payment_outbox_source.json" -H "Content-Type: application/json" http://localhost:8083/connectors | jq

curl -X POST --data-binary "@./connectors/source/equipment_source.json" -H "Content-Type: application/json" http://localhost:8083/connectors | jq
