...
public abstract class InitialPlayerAccountMapper {
    ...
    public abstract InitialPlayerAccountItemDto toDto(InitialPlayerAccountItemInfo item, @Context CurrencyMappingContext context);
