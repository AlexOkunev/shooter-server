...
import ru.otus.courses.java.advanced.shooter.server.gateway.admin.service.cache.CurrencyDtoCacheService;
...
public class CurrencyDtoCachingMappingContextFactory {
    ...
    public Mono<CurrencyDtoMappingContext> createForInitialItems(Mono<InitialPlayerAccountItemsPage> itemsPageMono) {
